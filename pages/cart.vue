            ...
            <div class="py-10 flex gap-6">
                ...
                <div class="w-[30%] bg-white shadow-xl h-max p-6">
                    ...
                    <span class="text-sm font-semibold">${{ item.price}}</span>
                        ...
                        <div v-else>
                            <p class="text-sm text-center font-light">There are no toorders yet</p>
                        </div>
                    </div>
                    ...
                    <button class="bg-blue-600 text-white text-base font-bold w-full py-2rounded-lg">Checkout</button>
                </div>
            </div>
        </div>
    </section>
